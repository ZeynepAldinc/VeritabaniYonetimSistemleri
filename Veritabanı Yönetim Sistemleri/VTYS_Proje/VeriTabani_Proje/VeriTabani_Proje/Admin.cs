...
namespace VeriTabani_Proje
{
    public partial class Admin : Form
    {
        ...
        {
            this.AdminAdi = KullaniciAdi;
            InitializeComponent();
        }

        private void Admin_Load(object sender, EventArgs e)
        {
            KullaniciAdiLb.Text = KullaniciAdiLb.Text + AdminAdi;
            baglanti = new NpgsqlConnection("Server=localhost; Port = 5432; UserID=postgres; password=98715130861; Database=Yasayan_Kutuphane");
            dataset = new DataSet();
            ...
            try
            {
                ...
                baglanti.Open();
                SqlIfade = "SELECT * FROM public.\"Kullanici\"";
                add = new NpgsqlDataAdapter(SqlIfade, baglanti);
                dataTb = new DataTable();
                add.Fill(dataTb);
                Kullanici_dataGridView.AutoGenerateColumns = false;
                Kullanici_dataGridView.DataSource = dataTb;
                baglanti.Close();
                //-------------------------------------------------
                ...
                while (dr.Read())
                {
                    ...
                    KullaniciDilCb.Items.Add(dr["Adi"]);
                ...
                KullaniciCinsiyetCb.Items.Add("Erkek");
                KullaniciCinsiyetCb.Items.Add("Kadın");
                //-------------------------------------------------
                ...
                while (dr.Read())
                {
                    ...
                    KullaniciUlkeCb.Items.Add(dr["Adi"]);
                }
                baglanti.Close();
                //-------------------------------------------------
        ...
        private void Urun_GuncelleBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlIfade = "UPDATE \"Urun\" SET \"Adi\" = \'" + KitapAdiTb.Text +
                    ...
                    "\' WHERE \"UrunID\" = \'" + UrunID_GuncelleNumericUpDown.ToString() + "\'";
                cmd = new NpgsqlCommand(SqlIfade, baglanti);
                cmd.ExecuteReader();
            }
            catch (Exception ex)
        ...
        private void YayinEvi_GuncellerBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlIfade = "UPDATE \"YayinEvi\" SET \"Adi\" = \'" + YayinEviAdi_GuncelleTb.Text +
                    "\' WHERE \"YazarID\" = \'" + YayinEviID_GuncelleNumericUpDown.Value.ToString() + "\'";
                cmd = new NpgsqlCommand(SqlIfade, baglanti);
                cmd.ExecuteReader();
            }
            catch (Exception ex)
        ...
        private void Cevirmen_GuncelleBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlIfade = "UPDATE \"Cevirmen\" SET \"Isim\" = \'" + CevirmenIsim_GuncelleTb.Text +
                    ...
                    "\' WHERE \"YazarID\" = \'" + CevirmenID_GuncelleNumericUpDown.Value.ToString() + "\'";
                cmd = new NpgsqlCommand(SqlIfade, baglanti);
                cmd.ExecuteReader();
            }
            catch (Exception ex)
        ...
        private void KitapSilBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                baglanti.Open();
                SqlIfade = "DELETE FROM \"Kitap\"WHERE \"YazarID\" = \'" + KitapIDSil_NumericUpDown.Value.ToString() + "\'";
                cmd = new NpgsqlCommand(SqlIfade, baglanti);
                cmd.ExecuteReader();
            }
            catch (Exception ex)
